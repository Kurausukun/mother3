...
public:
    ...
    virtual void onPPHeal(Unit* target);
    virtual void onSuccess(Unit* target);
    virtual void onInflictStatus(Unit* target);
    ...
    virtual void onPlayAnim(Unit* target, bool crit);
    virtual void action_140();
    virtual void action_148();
    virtual void action_150();
    virtual Msg ROMStr(u16) const;
    ...
    virtual u16 critAnimNo() const = 0;
