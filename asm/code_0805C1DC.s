...
// 	thumb_func_start ch_has_psi
// ch_has_psi: @ 0x0805C1DC
// 	push {r4, lr}
// 	adds r4, r0, #0
// 	bl ch_is_lucas
// 	lsls r0, r0, #0x18
...
// 	bx r1
	...
	thumb_func_start sub_0805C21C
sub_0805C21C: @ 0x0805C21C
	push {r4, lr}
	adds r4, r0, #0
	bl ch_is_lucas
	lsls r0, r0, #0x18
...
sub_0805C248: @ 0x0805C248
	...
	cmp r0, #1
	bne _0805C280
	ldr r0, _0805C27C @ =gUnknown_02004F70
	movs r2, #0
	cmp r4, #1
	bne _0805C272
	movs r2, #1
_0805C272:
	...
	b _0805C29E
	.align 2, 0
_0805C27C: .4byte gUnknown_02004F70
_0805C280:
	adds r0, r5, #0
	bl ch_is_kumatora
	lsls r0, r0, #0x18
	...
	cmp r0, #1
	bne _0805C29E
	ldr r0, _0805C2A8 @ =gUnknown_02004F8A
	movs r2, #0
	cmp r7, #1
	bne _0805C298
	movs r2, #1
...
_0805C29E:
	...
	bx r0
	.align 2, 0
_0805C2A8: .4byte gUnknown_02004F8A

	thumb_func_start sub_0805C2AC
sub_0805C2AC: @ 0x0805C2AC
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	lsls r1, r1, #0x10
	lsrs r4, r1, #0x10
	...
	cmp r0, #1
	bne _0805C2CC
	ldr r0, _0805C2C8 @ =gUnknown_02004F70
	adds r1, r4, #0
	b _0805C2DE
	.align 2, 0
_0805C2C8: .4byte gUnknown_02004F70
_0805C2CC:
	adds r0, r5, #0
	bl ch_is_kumatora
	lsls r0, r0, #0x18
	...
	cmp r0, #1
	bne _0805C2F8
	ldr r0, _0805C2F4 @ =gUnknown_02004F8A
	adds r1, r6, #0
_0805C2DE:
	bl sub_0805C58C
	movs r1, #0
...
_0805C2EE:
	...
	b _0805C2FA
	.align 2, 0
_0805C2F4: .4byte gUnknown_02004F8A
_0805C2F8:
	movs r0, #0
_0805C2FA:
	pop {r4, r5, r6}
	...
	thumb_func_start sub_0805C300
sub_0805C300: @ 0x0805C300
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	adds r5, r0, #0
	...
	cmp r0, #1
	bne _0805C338
	ldr r0, _0805C334 @ =gUnknown_02004F80
	movs r2, #0
	cmp r4, #1
	bne _0805C32A
	movs r2, #1
_0805C32A:
	...
	b _0805C356
	.align 2, 0
_0805C334: .4byte gUnknown_02004F80
_0805C338:
	adds r0, r5, #0
	bl ch_is_kumatora
	lsls r0, r0, #0x18
	...
	cmp r0, #1
	bne _0805C356
	ldr r0, _0805C360 @ =gUnknown_02004F9A
	movs r2, #0
	cmp r7, #1
	bne _0805C350
	movs r2, #1
...
_0805C356:
	...
	bx r0
	.align 2, 0
_0805C360: .4byte gUnknown_02004F9A

	thumb_func_start sub_0805C364
sub_0805C364: @ 0x0805C364
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	lsls r1, r1, #0x10
	lsrs r4, r1, #0x10
	...
	cmp r0, #1
	bne _0805C384
	ldr r0, _0805C380 @ =gUnknown_02004F80
	adds r1, r4, #0
	b _0805C396
	.align 2, 0
_0805C380: .4byte gUnknown_02004F80
_0805C384:
	adds r0, r5, #0
	bl ch_is_kumatora
	lsls r0, r0, #0x18
	...
	cmp r0, #1
	bne _0805C3B0
	ldr r0, _0805C3AC @ =gUnknown_02004F9A
	adds r1, r6, #0
_0805C396:
	bl sub_0805C58C
	movs r1, #0
...
_0805C3A6:
	...
	b _0805C3B2
	.align 2, 0
_0805C3AC: .4byte gUnknown_02004F9A
_0805C3B0:
	movs r0, #0
_0805C3B2:
	pop {r4, r5, r6}
	...
	thumb_func_start sub_0805C3B8
sub_0805C3B8: @ 0x0805C3B8
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	bl ch_is_lucas
	lsls r0, r0, #0x18
	...
	b _0805C3F6
_0805C3CC:
	ldr r4, _0805C404 @ =gUnknown_02004F70
	adds r0, r4, #0
	adds r1, r5, #0
	bl sub_0805C58C
	lsls r0, r0, #0x18
...
_0805C3F6:
	...
	b _0805C44E
	.align 2, 0
_0805C404: .4byte gUnknown_02004F70
_0805C408:
	adds r0, r6, #0
	bl ch_is_kumatora
	lsls r0, r0, #0x18
	...
	b _0805C444
_0805C41A:
	ldr r4, _0805C454 @ =gUnknown_02004F8A
	adds r0, r4, #0
	adds r1, r5, #0
	bl sub_0805C58C
	lsls r0, r0, #0x18
...
_0805C44E:
	...
	bx r0
	.align 2, 0
_0805C454: .4byte gUnknown_02004F8A

	thumb_func_start sub_0805C458
sub_0805C458: @ 0x0805C458
	push {r4, r5, r6, r7, lr}
	adds r4, r0, #0
	adds r7, r1, #0
	bl ch_is_lucas
...
_0805C514: .4byte gUnknown_02004F9A
	...
	thumb_func_start ch_is_lucas
ch_is_lucas: @ 0x0805C518
	push {lr}
	movs r1, #0
	cmp r0, #0
	beq _0805C528
...
_0805C528:
	...
	thumb_func_start ch_is_kumatora
ch_is_kumatora: @ 0x0805C530
	push {lr}
	movs r1, #0
	cmp r0, #0
	beq _0805C540
...
_0805C540:
	...
	thumb_func_start sub_0805C548
sub_0805C548: @ 0x0805C548
	push {r4, lr}
	adds r4, r0, #0
	adds r3, r1, #0
	lsls r2, r2, #0x18
...
_0805C5B4:
	...
	thumb_func_start sub_0805C5B8
sub_0805C5B8: @ 0x0805C5B8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0805C826:
	...
	thumb_func_start sub_0805C82C
sub_0805C82C: @ 0x0805C82C
	push {r4, lr}
	movs r3, #1
	movs r4, #1
_0805C832:
	...
	thumb_func_start sub_0805C850
sub_0805C850: @ 0x0805C850
	push {r4, r5, lr}
	adds r4, r2, #0
	ldr r0, [r4, #0x18]
	cmp r0, #0
...
_0805C880:
	...
	thumb_func_start sub_0805C888
sub_0805C888: @ 0x0805C888
	push {lr}
	bl sub_0805C850
	pop {r0}
	bx r0
